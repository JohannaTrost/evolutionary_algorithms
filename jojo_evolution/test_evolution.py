...
import jojo_evolution.data2plot as d2p
...
#test_variety_mutation_prob(100, 70, 3, data_sets, 'jojo_evolution/evo_results_mut')
avg_fitness, max_fitness = d2p.fetch_data(data_sets, 'jojo_evolution/evo_results_mut')
